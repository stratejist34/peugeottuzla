                    ...
                    <div className="lg:col-span-5 flex flex-col gap-6">
                        ...
                        >
                            ...
                            <p className="text-gray-400 leading-relaxed text-sm md:text-base">
                                Klas Oto, sadece parça değiştiren bir servis değil; aracınızın DNA&apos;sını analiz eden bir teknoloji merkezidir. 20 yılı aşkın süredir Tuzla&apos;da, profesyonel servis standartlarını butik hizmet anlayışıyla birleştiriyoruz.
                            </p>
                        </motion.div>
